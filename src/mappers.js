...
export class Mapper {
  ...
  onEndScanline(scanline) {
    ...
    // IRQ compare logic can live here later if needed
  }
...
class Mapper5 extends Mapper {
  constructor(nes) {
    ...
    this.hasPpuA13ChrSwitch = true;
    this.hasPpuScanlineHook = true;
...
// ============================================================
// Mapper 10 (MMC4) - Similar to MMC2 but with 16KB PRG switching instead of 8KB.
// ============================================================
